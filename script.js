...
function checkWin(i,j) { 
    ...
    if (RowElement1.className==RowElement2.className && RowElement2.className==RowElement3.className)
    {
        return true;
    }
    ...
    if(ColumnElement1.className==ColumnElement2.className && ColumnElement2.className==ColumnElement3.className)
    {
        return true;
    }
    ...
    if(crossElement1.className==crossElement2.className && crossElement2.className==crossElement3.className &&crossElement1.className!="cell")    {
        return true;
    }
    let crossElement4 = boardElement.children[0* 3 + 2];
    let crossElement6 = boardElement.children[2* 3 + 0];
    if(crossElement4.className==crossElement2.className && crossElement2.className==crossElement6.className &&crossElement4.className!="cell")    {
        return true;
    }
    return false;
}
...
function MakeRandomMove()
    {
        ...
        console.log(i);
        if(isXTurn && boardElement.children[i].className=="cell")
        {
            boardElement.children[i].classList.add("x");
            isXTurn=false;
        }
        else if(!isXTurn && boardElement.children[i].className=="cell")
        {
            boardElement.children[i].classList.add("x");
            isXTurn=true;
        }
